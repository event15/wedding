...
final class HomeController extends Controller
{
    ...
    public function headerAction(): JsonResponse
    {
        $data = [
            ...
            'subtitle' => '<i>Ty i ja spośród tysięcy<br>mocno trzymamy się za ręce.<br>Niezwykły dzień, doniosła chwila<br>i szept nieśmiały: miły... miła...<br>Odtąd już razem zawsze i wszędzie,<br>tak miało być i niech tak będzie!</i> <br><br> <strong>28 września 2018r</strong>',
